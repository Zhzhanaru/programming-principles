...
white = (255,255,255)
#resize and load
bg = pygame.transform.scale(pygame.image.load(os.path.join('clock\images','mikki.png')),(WIDTH, HEIGHT))
#second arrow and angle and pos 
sec_img = pygame.image.load(os.path.join('clock\images','m1.png'))
x_sec, y_sec = WIDTH/2 + 7, HEIGHT/2 - 5
#min arrow and angle and pos
min_img = pygame.image.load(os.path.join('clock\images','m2.png'))
